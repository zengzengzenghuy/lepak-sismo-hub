...
export const localFlows: Flow[] = [
  ...
  {
    path: "lepak-lifestyle-member", // choose your frontend path
    attester: hydraS1LocalAttester.name,
    network: Network.Local,
    attesterType: "hydra-s1", // choose your attester
    badgesCollection: hydraS1LocalBadges,
    badgesInternalCollectionsIds: [3], // choose your badge id here
    title: "Lepak LifeStyle Member", // choose your title 
    logoUrl: null,
    subtitle: "Attest your eligibility of Lepak LifeStyle", // choose your subtitle
    onboardingDescription: "LFG", // hype your users !
    ctaLabel: "Access gated channels", // shown after you successfully mint badge
    ctaUrl: "<https://discord.gg/gitcoin>", // provide a link to your users
    congratulationTexts: ["Join LepakLifeStyle !"],
  },
];
