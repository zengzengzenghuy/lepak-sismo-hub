...
var KV = /** @class */ (function () {
    ...
    KV.prototype.patch = function (key, value) {
        this.store[key] = __assign(__assign({}, this.store[key]), value);
    };
...
var KVMerkleTree = /** @class */ (function () {
    ...
    KVMerkleTree.prototype.initFromData = function (data) {
        ...
        var leaves = [];
        for (var key in data) {
            var value = BigNumber.from(data[key]);
            var leaf = void 0;
            if (this.hashLeaves) {
    ...
    KVMerkleTree.prototype.fillNodesWithPowerOf2Length = function (leaves) {
        ...
        return __spreadArray(__spreadArray([], leaves, true), new Array(next - leaves.length).fill(BigNumber.from(0).toHexString()), true);
    };
