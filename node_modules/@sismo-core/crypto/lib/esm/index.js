...
import { buildBabyjub as buildBabyjub$1, buildEddsa as buildEddsa$1, buildPoseidon as buildPoseidon$1 } from 'circomlibjs';
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, buildEddsa$1()];
                case 1:
                    eddsa = _a.sent();
                    _a.label = 2;
                case 2: return [2 /*return*/, eddsa];
            }
        });
    });
}
...
var EddsaAccount = /** @class */ (function () {
    ...
    EddsaAccount.generateFromSeed = function (seed) {
        return __awaiter(this, void 0, void 0, function () {
            var eddsa, babyjub, privKey, pubKey;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        return [2 /*return*/, new EddsaAccount(pubKey, privKey, eddsa, babyjub)];
                }
            });
        });
    };
...
export { EddsaAccount, SNARK_FIELD, buildPoseidon, keccak256 };
