  ...
  },
  {
    ...
    attestationsCollections: [
      ...
      },
      {
        ...
        groupFetcher: async (groupStore) => [
          await groupStore.latest("lepak-lifestyle-member"),
        ],
      }
    ],
  }
...
export const hydraS1LocalBadges: BadgesCollection = {
  ...
  badges: [
    ...
    },
    {
      ...
      name: "ZK Badge: Lepak-LifeStyle-Member", // add a name to your badge
      description: "ZK Badge received by Lepak Lifestyle Member", // describe it !
      image: "Lepak-Logo.svg", // give it a wonderful artwork ;)
      attributes: {},
      requirements: [],
    },
  ],
